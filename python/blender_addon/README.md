...
https://github.com/Baycosinus/mocap-for-blender/blob/master/video_facial_landmarks.py
https://devtalk.blender.org/t/compositor-improvements/13264/126
   ```
...
## pytest
```
py.test tests/test_ffmpeg_reader.py -s > /tmp/a.txt
```
...
```
https://pretagteam.com/question/how-to-hyperlink-image-in-blender
def draw(self, context):
   layout = self.layout
row = layout.row()
